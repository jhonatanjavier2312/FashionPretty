    ...
    return (<div className={classes.root}>
          <Card className={classes.card}>
            <CardContent>
              ...
              <TextField id="name" label="Nombre" className={classes.textField} value={auction.itemName} onChange={handleChange('itemName')} margin="normal"/><br/>
              <TextField
                ...
                margin="normal"
              /><br/>
              <TextField id="startingBid" label="Precio inicial ($)" className={classes.textField} value={auction.startingBid} onChange={handleChange('startingBid')} margin="normal"/><br/>
              <br/>
              <TextField
                id="datetime-local"
                label="Hora de inicio de la Oferta"
                type="datetime-local"
              ...
              <TextField
                id="datetime-local"
                label="Hora de finalización de la Oferta"
                type="datetime-local"
            ...
            <CardActions>
              <Button color="primary" variant="contained" onClick={clickSubmit} className={classes.submit}>Actualizar</Button>
            </CardActions>
          </Card>
    </div>)
}
