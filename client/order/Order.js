        ...
        <Grid container spacing={4}>
            ...
            <Grid item xs={5} sm={5}>
              <Card className={classes.innerCard}>
                ...
                <Typography type="subheading" component="h3" className={classes.thanks} color="primary">gracias por comprar con nosotros!<br/>Puede realizar un seguimiento del estado de sus artículos comprados en esta página.</Typography>
              </Card>
            </Grid>
        </Grid>
      </Card>
