...
export default function CartItems (props) {
  ...
  const openCheckout = () => {
    ...
    return (<Card className={classes.card}>
      ...
      {cartItems.length>0 ? (<span>
              ...
              <div className={classes.details}>
                <CardContent className={classes.content}>
                  ...
                  <div>
                    ...
                    <span className={classes.itemShop}>Comercio: {item.product.shop.name}</span>
                  </div>
                </CardContent>
                ...
                Cantidad: <TextField
                              ...
                              margin="normal"/>
                            <Button className={classes.removeButton} color="primary" onClick={removeItem(i)}>x Remover</Button>
                </div>
              </div>
            </Card>
            <Divider/>
        ...
        <div className={classes.checkout}>
          ...
          {!props.checkout && (auth.isAuthenticated()?
            <Button color="secondary" variant="contained" onClick={openCheckout}>Verificar</Button>
            :
            <Link to="/signin">
              <Button color="primary" variant="contained">Iniciar sesión para pagar</Button>
            </Link>)}
      ...
      <Typography variant="subtitle1" component="h3" color="primary">No se agregaron artículos a su carrito.</Typography>
    }
    </Card>)
}
