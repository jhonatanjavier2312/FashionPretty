             ...
             (<ListItemSecondaryAction>
               {user.seller &&
                 (user.stripe_seller
                   ...
                   : (<a href={"https://dashboard.stripe.com/login"+config.stripe_connect_test_client_id+"&scope=read_write"} className={classes.stripe_connect}>
